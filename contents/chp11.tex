...
\cref{fig:stochastic-approach-lcca} 描述了整个随机方法。简而言之，它反映了结果概率分布中输入因素（例如建筑和维修成本以及这些活动的时间安排）的不确定性。随机方法中涉及的具体步骤的描述如下。

\begin{figure}
  % \includegraphics[width=\linewidth]{stochastic-approach.pdf}
...
\begin{figure}
  % \includegraphics[width=\linewidth]{expert-opinion}
